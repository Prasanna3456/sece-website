...
@section('content')
    ...
    <section>
        <div class="glitch h-screen">
            ...
            <h1
                class="glitch__title sm:text-5xl mt-40 lg:mt-20 md:mt-20 md:text-8xl text-5xl  lg:text-[120px] text-yellow-500 pb-5 lg:py-0 md:py-0 uppercase text-center">
                Quintessence</h1>
            ...
            <div id="timer_exp"
                class="hidden z-40 text-4xl text-center text-yellow-500 md:text-5xl lg:text-5xl  font-semibold text-white oswald-bold-500">
                TODAY'S THE DAY
            </div>
    ...
    <section style="background-image: url('{{ asset('assets/img/bg_elements.png') }}') ">
        ...
        <h1
            class="sm:text-5xl text-center text-7xl text-yellow-500 lg:text-[110px]  px-5 py-5 lg:py-0  oswald-bold-800 uppercase">
            Events
        </h1>
                ...
                <div class="flex  duration-100 hover:scale-105 flex-col mb-12 overflow-hidden cursor-pointer bg-yellow-500 py-4 px-2"
                    ...
                    <a href="{{ route('technical_events') }}">
                        <div class="flex-shrink-0 mt-3">
                            <img class="object-cover w-full h-48" src="{{ asset('assets/img/tech_cover.jpeg') }}"
                                alt="">
                        </div>
                    </a>
    ...
    <section style="background-image: url('{{ asset('assets/img/bg_elements.png') }}') ">
        ...
        <h1
            class="sm:text-5xl text-center text-6xl text-yellow-500 lg:text-[110px]  px-5 py-5 lg:py-0  oswald-bold-800 uppercase">
            About Us
        </h1>
        <section class="text-gray-400  body-font">
            <div class="container mx-auto flex px-5 pt-24  md:flex-row flex-col items-center">
                <div
                    ...
                    <h1
                        class=" w-full title-font sm:text-4xl text-4xl text-white lg:text-7xl mb-4  oswald-bold-800 uppercase">
                        Quintessence
                    </h1>
                    <p class="mb-8 leading-relaxed">Quintessence, a national technical symposium hosted by the department of
                        Electronics and Communication Engineering, showcases engineering brilliance. The symposium combines
                        a wide range of technical and non-technical events, all of which are aimed to flummox our
                        participants' thoughts and illuminate their knowledge while maintaining a positive atmosphere. With
                        the use of a competitive platform, Quintessence aims to procure the top skills from them.</p>
        ...
        <section class="text-gray-400  body-font">
            <div class="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
                ...
                <div
                    ...
                    <h1
                        class="w-full title-font sm:text-4xl text-4xl text-white lg:text-5xl mb-4  oswald-bold-800 uppercase">
                        Easwari Enginerring College
                    </h1>
                    <p class="mb-8 leading-relaxed">Easwari Engineer­ing College, Auto­nomous From 2019, a unit of SRM Group
                        of Edu­cat­ional Instit­utions for higher learning is funct­ioning under Valliammai Society. The
                        College offers eleven Under-Graduate and six Post-Graduate Programmes covering Engineer­ing &
                        Tech­nology, and Management.</p>
                    <div class="flex justify-center">
                    </div>
                </div>
            </div>
