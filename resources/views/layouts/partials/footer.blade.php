    ...
    <div class="bg-black bg-opacity-30 ">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                ...
                <a href="https://wa.me/+919500068698" target="_blank" class="ml-3 text-gray-400   hover:text-green-500 cursor-pointer">
                ...
                <a href="mailto: quintessence.eec@gmail.com" target="_blank" class="ml-3 text-gray-400   hover:text-yellow-500 cursor-pointer">
