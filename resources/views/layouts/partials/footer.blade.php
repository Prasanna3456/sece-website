    ...
    <div class="bg-black bg-opacity-30 ">
        <div class="container mx-auto py-4 px-5 flex  w-full justify-evenly flex-wrap flex-col sm:flex-row">
            ...
            <span class="inline-flex sm:ml-auto sm:mt-0  justify-center sm:justify-start">
                ...
                <a href="https://instagram.com/quintessence_ece?igshid=YmMyMTA2M2Y=" target="_blank"
                    class="ml-3 text-gray-400 hover:text-red-500 cursor-pointer">
                ...
                <a href="https://wa.me/+919500068698" target="_blank"
                    class="ml-3 text-gray-400   hover:text-green-500 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" width="28" height="28"
                ...
                <a href="mailto: quintessence.eec@gmail.com" target="_blank"
                    class="ml-3 text-gray-400   hover:text-yellow-500 cursor-pointer">
