...
@section('content')
    ...
    <section class="text-gray-900  body-font py-8 bg-cover z-30 -mt-20"
        ...
        <div class="container mx-auto flex px-5 py-12 space-y-4 flex-col items-center justify-center orbitron">

            <div style="background-image: url('{{ asset('assets/img/sample-poster.jpg') }}');  backdrop-filter: blur(5px); "
                class="w-full max-w-4xl flex flex-col  sm:flex-row gap-3 sm:items-center  justify-between px-5 py-12 bg-cover bg-center bg-[#FF003C]">

                <div>
                    <!-- <span class="text-purple-800 text-sm">Engineering</span> -->
                    <h3 class="font-semibold  text-4xl mt-px text-white">ELECTRAPHILE</h3>
                    <h3 class="font-bold text-xl mt-px text-white">Quiz</h3>
                </div>
                <div>
                    <button class="bg-purple-900 text-white font-medium px-4 py-2 rounded-md flex gap-1 items-center">Apply
