...
{{-- About us section --}}
<section class="text-gray-900 bg-[#] body-font py-5" style="background-image: url('{{ asset('assets/img/bg_elements.png') }}') ">
    <h1 class="sm:text-5xl text-5xl text-black lg:text-[110px] text-[#FF003C] px-5 py-5 lg:py-0   oswald-bold-800 uppercase">ABOUT US
</h1>
<div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 class=" w-full title-font sm:text-4xl text-3xl text-black lg:text-4xl mb-4 font-medium h1 glitched cyberpunk orbitron uppercase">Quintessence 2k22
      </h1>
...
<!-- {{-- Events section --}}
<section class="text-gray-900 bg-black body-font py-5" style="background-image: url('{{ asset('assets/img/bg_elements_2.png') }}') ">
